-- ==============================================================================
-- Supabase Schema & Row-Level Security (RLS) for WA Lead Saver
-- NOTE: The official Supabase migrations are located in:
--       supabase/migrations/20260912160000_init_lead_saver_schema.sql
-- When GitHub is linked to Supabase, Supabase executes files from supabase/migrations/
-- ==============================================================================
